    ...
    <div className="relative min-h-screen py-20">
      ...
      <div className="container mx-auto px-4 relative">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-4xl font-bold mb-8 text-white text-center">Ram Navami</h1>
          
          <div className="bg-white/10 backdrop-blur-md rounded-lg p-8 shadow-xl border border-white/20">
            <div className="space-y-6 text-white/90">
              <h2 className="text-2xl font-semibold mb-6 text-white">Celebration of Lord Rama's Appearance</h2>
              ...
              <p>
                Ram Navami is a sacred festival celebrating the appearance day of Lord Rama, the 
                embodiment of dharma and virtue. Your support helps us organize grand celebrations 
                that bring devotees together in spiritual joy and devotion.
              </p>
              ...
              <div className="mt-8 p-6 bg-white/5 rounded-lg">
                ...
                <p>
                  To support our Ram Navami celebrations, please contact our festival coordination 
